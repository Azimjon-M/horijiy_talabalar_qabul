...
const Magistr = () => {
    ...
    const getDataMud = async () => {
        await APIMagistr.getMud().then((res) => setDataMud(res.data));
    };

    const getDataRoy = async () => {
        await APIMagistr.getRoy().then((res) => setDataRoy(res.data));
    };

    const getDataTol = async () => {
        await APIMagistr.getTol().then((res) => setDataTol(res.data));
    };

    const getDataTolMal = async () => {
        await APIMagistr.getTolMal().then((res) => setDataTolMal(res.data));
    };
